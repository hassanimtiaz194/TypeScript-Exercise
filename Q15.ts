...
const invitee2: string[] = ['Steve Jobs', 'Bill gates', 'Larry Page']
...
const newIndex2: (number | undefined)[] = invitee2.map(function (n, index) {
...
const filteredIndex2: (number | undefined)[] = newIndex2.filter((x) => {
    return x !== undefined;
});
let numb15: (number | any) = filteredIndex2[0];
