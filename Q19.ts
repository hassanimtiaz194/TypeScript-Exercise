...
const invitee19: string[] = ['Steve Jobs', 'Bill gates', 'Larry Page']
const message19: string[] = ['invitation Accepted', 'invitation Accepted', 'invitation Rejected']
const message192: string[] = ['invitation Accepted', 'invitation Accepted', 'invitation Accepted']
const message193: string[] = ['invitation Accepted', 'invitation Accepted', 'invitation Rejected', 'invitation Accepted', 'invitation Accepted', 'invitation Accepted']
const message194: string[] = ['You are still Invited', 'You are still Invited']
...
const newIndex19: (number | undefined)[] = invitee19.map(function (n, index) {
...
const filteredIndex19: (number | undefined)[] = newIndex19.filter((x) => {
    return x !== undefined;
});
let numb19: (number | any) = filteredIndex19[0];
// 2nd invitaion Send
